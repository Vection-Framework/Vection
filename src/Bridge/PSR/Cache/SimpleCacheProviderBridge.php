...
namespace Vection\Bridge\PSR\Cache;

use Vection\Contracts\Cache\CacheProviderInterface;
use Psr\SimpleCache\CacheInterface;

/**
 * Class SimpleCacheProviderBridge
 *
 * @package Vection\Bridge\PSR\Cache
 */
class SimpleCacheProviderBridge implements CacheProviderInterface
{
    /**
     * @var CacheInterface
     */
